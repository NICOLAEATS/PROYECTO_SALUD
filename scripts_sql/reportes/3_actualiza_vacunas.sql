...
WITH base AS (
    select  
        h.id_cita, h.anio, h.mes, h.cod_2000, h.red, h.nombre_establecimiento,
        h.codigo_item, h.valor_lab, h.tipo_diagnostico, h.tip_edad,
        h.edad, h.genero, h.id_etnia, h.fg_tipo
    FROM es_ivan.his_proceso h
    -- 2. Filtramos dinámicamente
    WHERE h.anio = {ANIO} AND h.mes {FILTRO_MES}
