...
WHERE codigo_item LIKE 'E86%' or codigo_item LIKE 'R57%' OR codigo_item LIKE 'K56%' OR codigo_item LIKE 'E87%'; -- ✅ AQUÍ FALTABA EL PUNTO Y COMA

DROP TABLE IF EXISTS es_ivan.IRAS_EDAS_2026;

CREATE TABLE es_ivan.IRAS_EDAS_2026 
AS
